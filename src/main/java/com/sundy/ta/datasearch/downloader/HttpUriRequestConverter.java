...
public class HttpUriRequestConverter {
    ...
    private RequestBuilder selectRequestMethod(Request request) {
        ...
        if (method == null || method.equalsIgnoreCase(Constant.Method.GET.getCode())) {
            //default get
            return RequestBuilder.get();
        } else if (method.equalsIgnoreCase(Constant.Method.POST.getCode())) {
            return addFormParams(RequestBuilder.post(),request);
        } else if (method.equalsIgnoreCase(Constant.Method.HEAD.getCode())) {
            return RequestBuilder.head();
        } else if (method.equalsIgnoreCase(Constant.Method.PUT.getCode())) {
            return addFormParams(RequestBuilder.put(), request);
        } else if (method.equalsIgnoreCase(Constant.Method.DELETE.getCode())) {
            return RequestBuilder.delete();
        } else if (method.equalsIgnoreCase(Constant.Method.TRACE.getCode())) {
